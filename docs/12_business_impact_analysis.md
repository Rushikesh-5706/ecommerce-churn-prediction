...
| Annual Churn Rate | 35.0% | From feature engineering |
...
**Annual Churners**:
3,213 customers × 35.0% = **1,125 churners/year**

**Lost Revenue**:
1,125 × £1,150 LTV = **£1,549,050/year**

**Random Retention Efforts** (if applied to all 3,213 customers):
- Cost: 3,213 × £50 = £160,650
- Success: 3,213 × 30% × 35.0% × £850 = £295,500 saved
...
**Risk 2: 35.0% Churn Rate (above 40% target)**
...
|--------|----------|------------------|-------------------|
| Monthly Churn Rate | 35.0% | 38.5% | 36.0% |
